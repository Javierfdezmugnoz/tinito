...
uint32_t(*ptr_fn_smm_technique[51])(uint32_t ui32_m, uint32_t ui32_n, uint32_t ui32_k, float32_t f32_alpha, const float32_t* const paf32_ma, const float32_t* const paf32_mb, float32_t* const paf32_mc) =
{
    smm_no_dc,
    smm_no_dc_opt,
...
{
    // ============================================================
    // Here is the code of the Safety Matrix-Matrix Multiplication
    // ============================================================
    ptr_fn_smm_technique[Aux_idx_tech]( M, N, K, ALPHA, (float32_t* const) A, (float32_t* const) B, (float32_t* const) C);

    // ============================================================
    // Here is the code of the non safety MMM
    // ============================================================
...
int is_avx() { // IF YOU WANT TO USE AVX => result =-1
    static int result = -1;
    if (result == -1) {
        check_cpu_features();
        result = HW_AVX;
...
int is_fma_avx2() {
    static int result = -1; // IF YOU WANT TO USE AVX => result =-1
    if (result == -1) {
        check_cpu_features();
    ...
    float *C, int ldc)
{
    ...
    if (is_avx() == 1) {    // AVX
        ...
        // ============================================================
        //      Here is the code of the MMM (non safety)
        // ============================================================
