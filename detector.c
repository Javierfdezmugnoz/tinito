    ...
    float hier_thresh, int dont_show, int ext_output, int save_labels, char *outfile, int letter_box, int benchmark_layers)
{
    ...
    while (1) {
        ...
        e_enum_technique e_tech;
            ...
            FILE *p_file;
            char str_file_name[300u];
            errno_t err;
        #endif
            //TECH_NONE TECH_MAX TECH_COMB
        for (e_tech = TECH_NONE; e_tech < TECH_INTEL_COMB; e_tech++)
        {
	    /* 1. Open output file (csv) */
            snprintf(str_file_name, 300u, "%s_tm.csv", pstr_technique[e_tech]);
            ...
            #endif
                fprintf(p_file, "%s,", pstr_technique[e_tech]);

            for (size_t TIME_MEASUREMENTS = 0; TIME_MEASUREMENTS < 10; TIME_MEASUREMENTS++)
            {
                // ==========================================================================
                //  Measure 1: Impact in full YOLO
                // ==========================================================================
                // Time Full YOLO :This measure does not include the time to parse the network
                //  nor the time to load the activations weights.
                // ==========================================================================
                ...
                // ==========================================================================
                //  Measure 2: Impact in the prediction
                // ==========================================================================
                // Init of the measure: the definition of time  and printf("%s ... / 1000)
                // should be commented if it is being measured measurement 1
                // ==========================================================================
                //double time = get_time_point();
                ...
                // End of the measure
                // ==========================================================================
                fprintf(p_file, "%lf,", ((double)get_time_point() - time) / 1000);
            }
            //fprintf(p_file, "\n");
            // Close the file where the result are been stored
            fclose(p_file);

            printf("%s.Idx=%i\t DONE\n", pstr_technique[e_tech],Aux_idx_tech);
            Aux_idx_tech++;
        }
        if (!dont_show) {
